...
// updating some states whenever the values of openedClassNum and studentProfile changes
  ...
  return (
    ...
    <div style={{display:'block', marginLeft:'50px', backgroundColor : "transparent"}}>
        <Table responsive>
            <tbody>
                <tr>
                    ...
                    <div className='classdiv'>
                        ...
                        <div className='session-contents'>
                            <h5 style={{color:'skyblue'}}>{`Class ${openedClassNum}: ${studentProfile.totalClassTitles[Number(openedClassNum)-1]}`}</h5>
                ...
                <tr>
                    ...
                    <div className='task-submission-div'>
                            <div>
                                ...
                                <div>
                                    <input className='task-submit-input' placeholder="Enter valid link of task source code" type='text' disabled={true} value={openedClassTaskSubmittedLink} />
                                ...
                                <div>
                                    <input className='task-submit-input' placeholder="Enter valid link of task source code" type='text' value={taskLinkFormData.submittedTaskLink} onChange={handleTaskLinkFormChange} />
                                    <span>{taskLinkFormErrors}</span>
                                    <br />
                                    <div className='task-submission-button-div'><Button className='task-submission-button' color='success' size='sm' onClick={handleTaskLinkFormSubmit} disabled={disableSubmit}>Submit</Button></div>
                                </div>
                            }
