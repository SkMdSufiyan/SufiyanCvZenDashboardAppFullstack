      ...
      <Navbar  expand="md" className='Navbar-class' fixed='top'>
        ...
        <Card style={{width: '18rem', backgroundColor : "transparent", border : "1px solid white", fontSize: "small"}}>
            ...
            {isTokenValid && ! apiCallError && ! isResetPasswordSuccess ? (
              ...
              <div>
                <Label className='Label-class'>Username (email)</Label>
                ...
                <Button color='success' size='sm' disabled={disableSubmit} className='Button-class' onClick={handleSubmitNewCred}>Submit</Button>
            ...
            {isTokenValid && ! apiCallError && isResetPasswordSuccess ? (
              ...
              <div>
                ...
                <br />
                <br />
                <Button color='info' size='sm' className='Button-class' onClick={() => navigate('/login')}>Login</Button>
              </div>
