        ...
        <h6 className='apiCallError-h6-class'>{apiCallError}</h6>
                ...
                <p className='actvities-p'>Portfolio</p>
                        <div>
                            ...
                            <div>
                                <input className='portfolio-submit-input' placeholder="Enter valid link of portfolio source code" type='text' disabled={true} value={portfolioSubmittedLink}/>
                            ...
                            <div>
                                <input className='portfolio-submit-input' placeholder="Enter valid link of portfolio source code" type='text' value={portfolioFormData.link} onChange={handlePortfolioFormChange}/>
                                <p><span>{portfolioFormErrors}</span></p>
                                <br />
                                <div className='task-submission-button-div'><Button className='task-submission-button' color='success' size='sm' onClick={handlePortfolioFormSubmit} disabled={disableSubmit}>Submit</Button></div>
                            </div>
                        }
                        </div>                  
                </div>
