...
const Home = () => {
  ...
  return (
    ...
    <p className='app-suggestion-p'><b style={{color : "rgb(47, 162, 207)"}}>The server of this application is deployed on a Render's free tier account</b>. Due to Render's <b style={{color : "rgb(47, 162, 207)"}}>"spinning down on idle"</b> issue, the server may take a little longer to start (when it is opened after a long time).</p>
    <p className='app-suggestion-p'>When you open this application's link for the <b style={{color : "rgb(47, 162, 207)"}}>first time</b>, please wait 15-30 seconds <b style={{color : "rgb(47, 162, 207)"}}>after submitting the requests for login, signup, or forgot password</b>.</p>
    <p className='app-suggestion-p'>If it takes much longer to respond <b style={{color : "rgb(47, 162, 207)"}}>(for the first time only)</b>, try closing and opening the app link one or two times.</p>

      
    <br />

        <h5 style={{color: "skyblue"}}>Welcome to Zen application </h5>
        ...
        <h6 style={{color: "whitesmoke"}}>Instructions</h6>
