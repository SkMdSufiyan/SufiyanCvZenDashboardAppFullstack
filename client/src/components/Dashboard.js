...
import { Button, Label, Navbar, Nav, NavItem, Card, CardBody } from "reactstrap";
  ...
  return (
    <div >
        ...
        <div className='dashboard-view-profile-button'>
            <Button className='dashboard-Button-class' color='info' size='sm' onClick={()=>setViewProfile(true)}>View Your Profile</Button>
        </div>
            ...
            {viewProfile ? (
                ...
                <Card style={{width:"18rem", backgroundColor : "transparent", border : "1px solid white", fontSize: "small"}} className='profile-card'>
                    <CardBody>
                            ...
                            {isEditProfile ? (
                                ...
                                <div>
                                    <Button className='dashboard-Button-class' color='success' size='sm' onClick={handleSubmitProfileForm} disabled={! isAllValidData}>Update</Button>
                                    <Button className='dashboard-Button-class' color='warning' size='sm' onClick={()=>{setProfileFormData(initialProfileFormData);setIsEditProfile(false)}}>Cancel</Button>
                                </div>

                            ) : (
                                <div>
                                    <Button className='dashboard-Button-class' color='info' size='sm' onClick={()=>setViewProfile(false)}>Close</Button>
                                    <Button className='dashboard-Button-class' color='warning' size='sm' onClick={()=>setIsEditProfile(true)}>Edit</Button>
                                </div>
                            )}
                            </div>
                    </CardBody>
